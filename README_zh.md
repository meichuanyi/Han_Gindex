...
[goindex/index.js](https://github.com/uxiaohan/Han_Gindex/go2index) 是Workers脚本的内容。
...
5. 下载`index.js` (https://github.com/uxiaohan/Han_Gindex/tree/master/go2index) 然后替换`client_id`,`client_secret`,`refresh_token` 为你刚刚获取到的
...
- 美化：网格模式文件无预览图时显示图标
- 美化：调整HEAD.md渲染位置
- 解决搜索不能预览的文件点击无法直接下载 [#30](https://github.com/uxiaohan/Han_Gindex/issues/30)
- 解决文件名中有#无法打开的问题 [#20](https://github.com/uxiaohan/Han_Gindex/issues/20)
- 解决当前页面加载中切换页面会回退的问题 [#37](https://github.com/uxiaohan/Han_Gindex/issues/37) (感谢[@PedroZhang](https://github.com/PedroZhang)帮忙找出的问题原因)
...
- 支持PDF在线预览
- 更换文本编辑器
- 解决url编码问题 [#20](https://github.com/uxiaohan/Han_Gindex/issues/20) [#23](https://github.com/uxiaohan/Han_Gindex/issues/23) [#25](https://github.com/uxiaohan/Han_Gindex/issues/25)
- 解决其他已知问题
